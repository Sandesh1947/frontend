            ...
            <Modal show={true} onHide={this.props.close}>
                ...
                <Modal.Body>
                    {type === 'liked' ? <React.Fragment>{
                        ...
                        {likedUsers.loading ? <div className='text-center'><Spinner animation="border" /> </div> : (!likedUsers.noMoreData ? <div onClick={this.props.loadMore} className='load-more-link'>Load More</div> : <div className='text-center'>No More Data</div>)}
                            ...
                            {promotedUsers.loading ? <div className='text-center'><Spinner animation="border" /> </div> : (!promotedUsers.noMoreData ? <div onClick={this.props.loadMore} className='load-more-link'>Load More</div> : <div className='text-center'>No More Data</div>)}
                        </React.Fragment>}
                </Modal.Body>
            </Modal>
        )
