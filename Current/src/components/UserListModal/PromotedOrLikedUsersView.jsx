      ...
      <React.Fragment>
        ...
        >
          <Popover id="popover-contained" title="View Profile">
            <strong><Link to={{ pathname: '/profile/', search: queryString.stringify(Object.assign({}, { user_id: user.user_id })), state: { currentuser: user.currentuser } }}>Click to view profile of {user.first_name}</Link></strong>
          </Popover>
        </Overlay>
      </React.Fragment>
    )
